...
public class StatisVsNonStatic {
	...
	public static void main(String[] args) {
		...
		// method with static keyword is called static method, var denoted with static is called static variable
		...
		//Whenever the object(RHS) non static stuff got created will stored in heap memory
		//Static stuff will always be stored into CMA, Object will never hold static stuff 
		//Static stuff can be called by obj but warning u should get, Ststic stuff id the common properties for all the objects

...
public class Inheritance_Test {
	...
	public static void main(String[] args) {
		...
		Inheritance_Parent parent = new Inheritance_Child();// parent class refe and child class object
		...
		//In intefaces downcasting is not allowed at the compile time also
